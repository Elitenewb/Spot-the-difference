(() => {
  ...
  const SAFE_EDIT_FOLLOWUP = 'TOOL POLICY: Do not call, open, or hand this task to Adobe, Photoshop, Canva, or any other external or connected app, plugin, action, API, or editing tool. Do not ask for tool permission. Use only ChatGPT\'s native image editing in this conversation. Edit the uploaded crop directly and return an edited image now, without explaining. Make exactly one clear, fun, reality-changing difference that will be noticeable in a spot-the-difference game when this crop is placed back into a larger image. Choose the change that best fits the crop; faces, expressions, hair, anatomy, objects, and scenery are valid targets. Do not add stickers, labels, or graphic overlays. Keep the crop framing and all unrelated content unchanged. Return only the edited image.';
